function [out] = own_cubic2equi_height(top, bottom, left, right, front, back)
...
imagesRed = double(zeros(960, 960, 6));
imagesGreen = double(zeros(960, 960, 6));
imagesBlue = double(zeros(960, 960, 6));
...
out = double(zeros(3840,1920,3));
%double(zeros(960, 960, 6));
