...
L197 = tonemap(hdrimread('p405.hdr'));
L198 = tonemap(hdrimread('p406.hdr'));
...
hdrimwrite(newRGBImage, 'Poker3BWD.hdr');
rgbExtra = tonemap(newRGBImage);
imwrite(rgbExtra, 'Poker3BWD.jpg');
...
save('Poker3BWD.mat','motion_conf_bwd');%bwd
