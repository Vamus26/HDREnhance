...
L194 = tonemap(hdrimread('p403.hdr'));
L195 = tonemap(hdrimread('p404.hdr'));
H214 = hdrimread('p403.hdr');
...
hdrimwrite(newRGBImage, 'Poker1FWD.hdr');
rgbExtra = tonemap(newRGBImage);
imwrite(rgbExtra, 'Poker1FWD.jpg');
...
save('Poker1FWD.mat','motion_conf_fwd');%fwd
