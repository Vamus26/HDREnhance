...
H214 = hdrimread('p405.hdr');
L197 = tonemap(hdrimread('p404.hdr'));
L198 = tonemap(hdrimread('p405.hdr'));
...
hdrimwrite(newRGBImage, 'Poker1BWD.hdr');
rgbExtra = tonemap(newRGBImage);
imwrite(rgbExtra, 'Poker1BWD.jpg');
...
%save('WaterFWD3.mat','motion_conf_fwd');%fwd
save('Poker1BWD.mat','motion_conf_bwd');%bwd
