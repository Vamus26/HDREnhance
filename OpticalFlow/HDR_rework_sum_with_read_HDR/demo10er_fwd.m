...
hdrimwrite(newRGBImage, 'Poker20FWD.hdr');
rgbExtra = tonemap(newRGBImage);
imwrite(rgbExtra, 'Poker20FWD.jpg');
...
save('Poker20FWD.mat','motion_conf_fwd');%fwd
%save('BridgeBWD20_14_04_bwd.mat','motion_conf_bwd');%bwd
