...
public:
	...
	static void SmoothFlowSORPlusThird(const DImage& Im1, const DImage& Im2, DImage& warpIm2, DImage& vx, DImage& vy,
	...
	static void Coarse2FineFlowOrig(DImage& vx, DImage& vy, DImage &warpI2, const DImage& Im1, const DImage& Im2, double alpha, double ratio, int minWidth,
	...
	static void Coarse2FineFlowExt(DImage& vx, DImage& vy, DImage &warpI2, const DImage& Im1, const DImage& Im2, double alpha, double ratio, int minWidth,
		int nOuterFPIterations, int nInnerFPIterations, int nCGIterations, DImage &warpI3, const DImage& Im3, const DImage& Im4);
	...
	static void ComputeOpticalFlow(const DImage& Im1,const DImage& Im2,DImage& flow)
	{
		...
		DImage vx,vy,warpI2;
		mexErrMsgTxt("removed To work optical flow.h:106");
