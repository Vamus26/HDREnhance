...
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_DSS_CREATE' :: DSS_CREATE
      ...
      INTERFACE
        FUNCTION DSS_DEFINE_STRUCTURE( HANDLE, OPT, ROWINDEX, NROWS, RCOLS, COLUMNS, NNONZEROS )
          USE MKL_DSS_PRIVATE
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_DSS_DEFINE_STRUCTURE' :: DSS_DEFINE_STRUCTURE
...
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_DSS_REORDER' :: DSS_REORDER
      ...
      INTERFACE
        FUNCTION DSS_FACTOR_REAL( HANDLE, OPT, RVALUES )
          USE MKL_DSS_PRIVATE
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_DSS_FACTOR_REAL' :: DSS_FACTOR_REAL
          TYPE(MKL_DSS_HANDLE), INTENT(INOUT) :: HANDLE
          INTEGER(KIND=4),       INTENT(IN)    :: OPT
      ...
      INTERFACE
        FUNCTION DSS_FACTOR_COMPLEX( HANDLE, OPT, RVALUES )
          USE MKL_DSS_PRIVATE
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_DSS_FACTOR_COMPLEX' :: DSS_FACTOR_COMPLEX
          TYPE(MKL_DSS_HANDLE), INTENT(INOUT) :: HANDLE
          INTEGER(KIND=4),       INTENT(IN)    :: OPT
...
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_DSS_SOLVE_REAL' :: DSS_SOLVE_REAL
      ...
      INTERFACE
        FUNCTION DSS_SOLVE_COMPLEX( HANDLE, OPT, RRHSVALUES, NRHS, RSOLVALUES )
          USE MKL_DSS_PRIVATE
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_DSS_SOLVE_COMPLEX' :: DSS_SOLVE_COMPLEX
          TYPE(MKL_DSS_HANDLE), INTENT(INOUT) :: HANDLE
          INTEGER(KIND=4),       INTENT(IN)    :: OPT
          INTEGER(KIND=4),       INTENT(IN)    :: NRHS
...
!DEC$ ATTRIBUTES C, REFERENCE, ALIAS:'_MKL_CVT_TO_NULL_TERMINATED_STR' :: MKL_CVT_TO_NULL_TERMINATED_STR
